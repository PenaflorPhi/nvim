...
map("n", "<leader>Tf", function() T("find_files") end, "Telescope: Find files")
map("n", "<leader>Tg", function() T("live_grep") end,  "Telescope: Live grep")
map("n", "<leader>Tb", function() T("buffers") end,    "Telescope: Buffers")
map("n", "<leader>Th", function() T("help_tags") end,  "Telescope: Help tags")
map("n", "<leader>Tr", function() T("resume") end,     "Telescope: Resume")
map("n", "<leader>Tc", function() T("commands") end,   "Telescope: Commands")
-- LSP-aware pickers (only do something when LSP attached)
map("n", "<leader>Ts", function() T("lsp_document_symbols") end, "Telescope: Doc symbols")
map("n", "<leader>Tw", function() T("lsp_dynamic_workspace_symbols") end, "Telescope: WS symbols")
map("n", "<leader>Tk", function() T("keymaps") end, "Telescope: Keymaps")
...
map("n", "<leader>N", function() vim.diagnostic.goto_prev({ float = diag_float }) end, "Diagnostics: Previous")
map("n", "<leader>n", function() vim.diagnostic.goto_next({ float = diag_float }) end, "Diagnostics: Next")
...
map("i", "<C-k>", function() vim.lsp.buf.signature_help() end, "LSP: Signature help")
